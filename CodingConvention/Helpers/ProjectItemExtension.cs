...
namespace CodingConvention.Helpers
{
    ...
    /// </summary>
    internal static class ProjectItemExtension
    {
        /// <summary>
        ...
        internal static string GetFileName(this ProjectItem projectItem)
        {
            ...
            {
                OutputWindowHelper.WriteError($"Unable to retrieve ProjectItem file name: {ex}");
                return null;
            }
        }
        ...
        internal static ProjectItem GetParentProjectItem(this ProjectItem projectItem)
        {
            ...
            {
                OutputWindowHelper.WriteError($"Unable to retrieve parent ProjectItem: {ex}");
                return null;
            }
        }
        ...
        internal static bool IsExternal(this ProjectItem projectItem)
        {
            ...
            {
                OutputWindowHelper.WriteError($"Unable to determine if ProjectItem is external: {ex}");
                return false;
            }
        }
        ...
        internal static bool IsPhysicalFile(this ProjectItem projectItem)
        {
            ...
            catch (Exception ex)
            {
                ...
                OutputWindowHelper.WriteError($"Unable to determine if ProjectItem is a physical file: {ex}");
                return false;
            }
        }
    }
